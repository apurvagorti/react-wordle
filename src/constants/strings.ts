...
export const WIN_MESSAGES = ['You guessed it!', 'You got it!']
export const GAME_COPIED_MESSAGE = 'Game copied to clipboard'
export const NOT_ENOUGH_LETTERS_MESSAGE = 'Not enough digits'
export const WORD_NOT_FOUND_MESSAGE = 'Date not found or not in range'
...
export const STATISTICS_TITLE = 'Save the Date'
